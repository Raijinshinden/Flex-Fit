...
function Sidenav() {
  ...
  return (
    <div>
        <AiOutlineMenu onClick={handleNav} className='bg-gray-600 size-14 p-2 rounded-full fixed top-5 sm:right-3 z-[99] fill-amber-500 hover:cursor-pointer hover:bg-white hover:rounded-full md:hidden'/>
        {
            nav ? (
