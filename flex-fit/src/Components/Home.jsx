    ...
    return (
        <section id="home">
            <div>
                ...
                <button className="bg-amber-500 px-4 py-2 mt-2 text-2xl text-white rounded-full hover:bg-white hover:text-amber-500 transition delay-10 hover:ease-in-out">Trial</button>
                </div>
            </div>
        </section>
    );
