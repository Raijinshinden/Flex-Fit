...
const About = () => {
  return (
    ...
    <div className='grid-cols-2 grid-rows-7 w-full md:px-10 py-10 bg-gray-800 overflow-hidden' id='about'>
      ...
      <div className='sm:col-start-1 row-start-2 mx-12 space-y-6 lg:grid grid-cols-4 grid-rows-8 gap-8'>
        <div className='md:col-span-2 row-span-1'>
          <img src='/images/man-weights.jpg' className='size-96 sm:w-full md:rounded-lg h-full mt-6'/>
        </div>
