  ...
  return (
    ...
    <div className='flex flex-col w-full md:px-20 p-4 py-16 bg-gray-800' id='about'>
      ...
      <div className='mt-3 bg-gray-700 '>
        <img src='/images/man-weights.jpg' className='float-right rounded-lg h-80 pt-2 pr-10'/>
      ...
      <div className='pt-3'>
        ...
        <p className='items-start bg-gray-700 rounded-lg p-3 block text-xl text-white'>
            ...
            Our Gyms are also CAMERA-FREE environments, so our members never have to worry about videos of themselves
