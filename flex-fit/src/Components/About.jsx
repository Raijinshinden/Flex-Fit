...
const About = () => {
  return (
    ...
    <div className='grid-cols-2 grid-rows-7 w-full md:px-10 py-10 bg-gray-800 overflow-hidden' id='about'>
      ...
      <h2 className='sm:col-start-1 row-auto mb-6 mx-4 md:mb-2 bg-gray-700 text-center rounded-full text-3xl font-bold text-amber-500 py-4'>
            About Us
        </h2>
      </div>


      <div className='sm:col-start-1 row-start-2 mx-12 md:flex justify-evenly'>
