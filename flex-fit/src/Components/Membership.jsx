...
const Membership = () => {
  return (
    <div className='w-full sm:px-5 sm:py-5 md:px-10 py-10 bg-gray-800 overflow-hidden'id='membership'>
        <h2 className='sm:col-start-1 row-start-1 mb-6 ml-3 mr-10 md:mb-3 bg-gray-700 text-center rounded-full text-3xl font-bold text-amber-500 py-4' >
            Membership
        </h2>
        <div className='sm:justify-center md:flex justify-evenly gap-3'>
            <div className='h-full pb-1 sm:mb-6 sm:w-3/4 sm:ml-16 md:w-4/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer transition delay-75 hover:ease-in-out sm:col-start-1 row-start-2'>
              <img src='/images/gym-basic.jpg' className='rounded-xl mt-3 h-20'/>
