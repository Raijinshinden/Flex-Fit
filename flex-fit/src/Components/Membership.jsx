  ...
  return (
    <div className='w-full sm:px-5 sm:py-5 md:px-10 py-10 bg-gray-800 overflow-hidden'id='membership'>
        ...
        <div className='sm:justify-center md:flex justify-evenly gap-3'>
            <div className='h-full pb-1 sm:mb-6 sm:w-3/4 sm:ml-16 md:w-4/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-2'>
                ...
                <div className='p-2 m-6 bg-amber-500 rounded-lg text-center font-bold text-white text-4xl transition delay-100 hover:ease-in-out'>
                  $50.00
                </div>
            </div>
            <div className='h-full pb-1 sm:mb-6 sm:w-3/4 sm:ml-16 md:w-4/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-3 mx-3'>
                <h3 className='text-white text-2xl text-center font-bold my-2'>
                  Enthusiast
                </h3>
                <p className='text-center text-white'>
            ...
            <div className='h-full pb-1 sm:mb-6 sm:w-3/4 sm:ml-16 md:w-4/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-4 mx-3'>
                <h3 className='text-white text-2xl text-center font-bold my-2'>
                  Gym Rat
                </h3>
                <p className='text-center text-white'>
