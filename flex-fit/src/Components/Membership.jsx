  ...
  return (
    <div className='w-full md:px-10 py-10 bg-gray-800 overflow-hidden'id='membership'>
        ...
        <div className='sm:grid md:flex justify-evenly gap-3'>
            <div className='h-full w-3/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-2'>
            ...
            <div className='h-full w-3/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-3 mx-3'>
                <h3 className='text-white text-2xl text-center font-bold my-2'>
                  Enthusiast
                </h3>
                <p className='text-center text-white'>
            ...
            <div className='h-full w-3/12 bg-gray-700 rounded-xl px-4 shadow-2xl hover:shadow-black hover:cursor-pointer sm:col-start-1 row-start-4 mx-3'>
                <h3 className='text-white text-2xl text-center font-bold my-2'>
                  Gym Rat
                </h3>
                <p className='text-center text-white'>
