...
const Classes = () => { 
  return (
    <div className='grid w-full md:px-10 py-10 bg-gray-800 overflow-hidden' id='classes'>
        ...
        <div className='sm:col-start-1 row-start-2 mx-12 md:grid-cols-4 md:grid-rows-2'>
          <div className='shadow-2xl p-2 hover:shadow-black hover:cursor-pointer transition delay-100 hover:ease-in-out sm:col-start-1 mb-6 bg-gray-700 rounded-xl md:col-start-1 col-span-1 row-start-1 row-span-1 w-3/12 h-full'>
          ...
          <div className='shadow-2xl p-2 hover:shadow-black hover:cursor-pointer transition delay-100 hover:ease-in-out sm:col-start-1 mb-6 bg-gray-700 rounded-xl md:col-start-2 col-span-1 row-start-1 row-span-1 md:w-3/12 md:h-full'>
          ...
          <div className='shadow-2xl p-2 hover:shadow-black hover:cursor-pointer transition delay-100 hover:ease-in-out sm:col-start-1 row-start-2 mb-6 bg-gray-700 rounded-xl px-2 md:w-3/12 md:h-full'>
            <img src='/images/karate.jpg' className='p-2 rounded-xl'/>
            <h3 className='text-white text-2xl text-center font-bold my-2 px-3'>
              Karate
            </h3>
            <p className='text-white p-2'>
