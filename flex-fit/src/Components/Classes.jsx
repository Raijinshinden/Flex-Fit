...
const Classes = () => { 
  return (
    <div className='grid grid-cols-4 grid-rows-3 w-full md:px-10 py-10 bg-gray-800 overflow-hidden' id='classes'>
        <h2 className='sm:col-start-1 sm:row-start-1 col-span-4 row-auto w-full  mb-6 mx-3 md:mb-3 md:mt-10 bg-gray-700 text-center rounded-full text-3xl font-bold text-amber-500 py-4'>
            Classes
        </h2>
        ...
        <div className='sm:col-start-1 row-start-3 mx-12 md:grid grid-col-4 grid-row-1'>
          <div className='col-start-1 row-start-1 shadow-2xl p-2 hover:shadow-black hover:cursor-pointer transition delay-100 hover:ease-in-out sm:col-start-1 row-start-2 mb-6 bg-gray-700 rounded-xl md:w-3/12 md:h-full'>
            <img src='/images/aerobics.jpg' className='p-2 rounded-xl'/>
            <h3 className='text-white text-2xl text-center font-bold my-2 px-3'>
              Aerobics
            </h3>
